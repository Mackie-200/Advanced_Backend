  ...
  return (
    <section className="py-12 sm:py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row lg:flex-wrap gap-3 sm:gap-4 justify-center mt-8 sm:mt-12">
          <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base flex-1 sm:flex-initial lg:max-w-xs">
            Book Now
          </Button>
          <Button variant="outline" size="lg" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base flex-1 sm:flex-initial lg:max-w-xs">
            Book Your Platform
          </Button>
          <Button variant="outline" size="lg" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base flex-1 sm:flex-initial lg:max-w-xs">
            Contact Us
